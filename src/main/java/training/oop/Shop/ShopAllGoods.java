...
class ShopAllGoods {
    ...
    public static void main(String[] args) {
        ...
        allGoods.add(new eBook("JSP [e]", 39.9, 50));
        allGoods.add(new eBook("Spring Boot [e]", 31.9, 130));
        allGoods.add(new CdMusic("Dark side of the Moon", 11.9, 76));
        allGoods.add(new CdMusic("Wall", 25.99, 87));
        allGoods.add(new eCdMusic("Enjoy the silence [e]", 3.99, 3));
        allGoods.add(new eCdMusic("Walk in my shoes [e]", 3.99, 4));
