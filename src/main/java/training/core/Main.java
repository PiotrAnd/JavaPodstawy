...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("char " + 'z'); // char można wstawić tylko pojedynczy znak, do wielu znaków służy metoda String
        ...
        System.out.println("String " + new String( "Mój napis."));// nie ma możliwości jej rozszerzenia
